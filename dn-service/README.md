...
Issues: [monorepo](https://github.com/dolphinnet-labs/dolphinnet/issues?q=is%3Aissue%20state%3Aopen%20label%3AA-dn-service)

Pull requests: [monorepo](https://github.com/dolphinnet-labs/dolphinnet/pulls?q=is%3Aopen+is%3Apr+label%3AA-dn-service)

`dn-service` is a collection of Go utilities to build OP-Stack services with.
...
- Remove unused utilities: `dn-service` itself needs to stay maintainable.
- Make all Go services consistent: `dn-service` modules can be used to simplify and improve more Go services.
...
Each dn-service package has its own unit-testing.
