...
import (
	...
	client_mocks "github.com/dolphinnet-labs/dolphinnet/dn-service/client/mocks"
	"github.com/dolphinnet-labs/dolphinnet/dn-service/eth"
	"github.com/dolphinnet-labs/dolphinnet/dn-service/sources/mocks"
)

//go:generate mockery --srcpkg=github.com/dolphinnet-labs/dolphinnet/dn-service/apis --name BlobSideCarsClient --with-expecter=true

//go:generate mockery --srcpkg=github.com/dolphinnet-labs/dolphinnet/dn-service/apis --name BeaconClient --with-expecter=true
