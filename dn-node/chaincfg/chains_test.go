...
// the configs that were embedded in the dn-node manually before the superchain-registry was utilized.
//
...
//
// This test ensures no dn-node config-loading behavior changes before
